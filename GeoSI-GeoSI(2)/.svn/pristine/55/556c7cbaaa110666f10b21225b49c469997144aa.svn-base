...
{
    public partial class BackOffice : LoginGeo
    {
        ...
        protected void btnVerify_Click(object sender, EventArgs e)
        {
            if (txtUsername.Text != "" && txtPassword.Text != "" && txtCaptcha.Text != "")
            {
                ...
                string _req = "select userbackofficeid,email,prenom from userbackoffice where login='" + Login + "' and pwd='" + Password + "' and actif='1'";
