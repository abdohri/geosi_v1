<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RapportActiv.aspx.cs" Inherits="GeoSI.Website.Modules.RapportActiv.RapportActiv" %>
        ...
        <ColumnModel ID="ColumnModel1" runat="server">
            ...
            <Columns>
                ...
                <HeaderItems>
                    ...
                    <Listeners>
                        <Command Handler="addPdf(record.data.vehiculeid);" />
                    </Listeners>
                </ext:CommandColumn>
                ...
                <ext:CommandColumn ID="CommandColumn1" runat="server" Width="30">
                    ...
                    <Listeners>
                        <Command Handler="addPdfo(record.data.vehiculeid);" />
                    </Listeners>
                </ext:CommandColumn>
