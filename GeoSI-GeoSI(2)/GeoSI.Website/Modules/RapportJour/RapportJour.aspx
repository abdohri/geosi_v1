<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RapportJour.aspx.cs" Inherits="GeoSI.Website.Modules.RapportJour.RapportJour" %>
        ...
        <ColumnModel ID="ColumnModel1" runat="server">
            ...
            <Columns>
                ...
                <HeaderItems>
                    ...
                    <Listeners>
                        <Command Handler="rjpdf(record.data.vehiculeid);" />
                    </Listeners>
                </ext:CommandColumn>
                ...
                <ext:CommandColumn ID="CommandColumn1" runat="server" Width="30">
                    ...
                    <Listeners>
                        <Command Handler="rjexcel(record.data.vehiculeid);" />
                    </Listeners>
                </ext:CommandColumn>
