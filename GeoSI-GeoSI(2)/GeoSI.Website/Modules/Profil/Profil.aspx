<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profil.aspx.cs" Inherits="GeoSI.Website.Modules.Profil.Profil" %>

<%--<asp:Content ID="ContentPlaceHolder2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
 <title>Profil</title>
</asp:Content>--%>
            ...
            var getRecordFilter = function () {
                ...
                f.push({
                    filter: function (record) {                         
                        return filterString(#{ComboBox1}.getValue()||"", "action", record);
                    }
                });

                f.push({
                    filter: function (record) {                         
                        return filterString(#{ComboBox2}.getValue(), "matricule", record);
                    }
                }); 
                ...
                f.push({
                    filter: function (record) {                         
                        return filterString(#{profilFilter}.getValue()||"", "libelle", record);
                    }
                });
...
<asp:content id="BodyContent" runat="server" contentplaceholderid="ContentPlaceHolder1">
     <%--Déclaration du grid--%>
    <ext:GridPanel ID="GridPanel" runat="server" Layout="FitLayout" ForceFit="true" Border="false" Header="false">

         <%--Définition des éléments du store utilisé dans le grid--%>
        <Store>
            <ext:Store ID="StoreGrid" runat="server" RemoteSort="true" AutoSync="true" PageSize="10"
                OnReadData="MyData_Refresh">
                <Model>
                    <ext:Model ID="Model1" runat="server" IDProperty="profilid">
                        <Fields>
                            <ext:ModelField Name="profilid" Type="Int" UseNull="true" />
        ...
        <ColumnModel ID="ColumnModel1" runat="server">
            <Columns>
                <ext:Column ID="Column1" runat="server" Text="<%$ Resources:Resource,Profil_id%>" DataIndex="profil"  Hidden="true" />
                <ext:Column ID="Column2" runat="server" Text="<%$ Resources:Resource,Profil_profil%>" DataIndex="libelle" >
                     <HeaderItems>
                            <ext:TextField ID="profilFilter" runat="server" EnableKeyEvents="true">
                                <Listeners>
                ...
                <ext:Column ID="Column3" runat="server" Text="<%$ Resources:Resource,Profil_description%> " DataIndex="description">
                     <HeaderItems>
                ...
                <%-- <ext:Column ID="Column5" runat="server" Text="<%$ Resources:Resource,Profil_Habilitation%>" Items="" >
                      </ext:Column>
                 <Plugins>
              ...
              <%--  <ext:Column ID="Column4" runat="server" text="<%$ Resources:Resource,Profil_Habilitation%>"  DataIndex="action">
             ...
             --%>
                ...
                <ext:CommandColumn ID="CommandColumn1" runat="server" Width="30">
                    ...
                    <Listeners>
                        <Command Handler="EditLightbox(record.data.profilid);" ></Command>
                    </Listeners>
                </ext:CommandColumn>
                 <ext:CommandColumn ID="CommandColumn2" runat="server" Width="30">
                    ...
                    <Listeners>
                         <Command Handler="GridDelete(record.data.profilid);" />
                    </Listeners>
                </ext:CommandColumn> 
            </Columns>
        </ColumnModel>
