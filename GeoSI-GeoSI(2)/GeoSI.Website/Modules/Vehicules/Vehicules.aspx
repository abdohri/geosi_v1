<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vehicules.aspx.cs" Inherits="GeoSI.Website.Modules.Vehicules.Vehicules" %>
        ...
        <ColumnModel ID="ColumnModel1" runat="server">
            ...
            <Columns>
                ...
                <ext:CommandColumn ID="CommandColumn1" runat="server" Width="30">
                    ...
                    <Listeners>
                        <Command Handler="EditLightbox(record.data.vehiculeid);" />
                    </Listeners>
                </ext:CommandColumn>
                 ...
                 <ext:CommandColumn ID="CommandColumn2" runat="server" Width="30">
                    ...
                    <Listeners>
                        <Command Handler="GridDelete(record.data.vehiculeid);" />
                    </Listeners>
                </ext:CommandColumn> 
            </Columns>
        </ColumnModel>
