<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RapportArret.aspx.cs" Inherits="GeoSI.Website.Modules.RapportArret.RapportArret" %>
        ...
        <ColumnModel ID="ColumnModel1" runat="server">
            ...
            <Columns>
                ...
                <HeaderItems>
                    ...
                    <Listeners>
                        <Command Handler="rapdf(record.data.vehiculeid);" />
                    </Listeners>
                </ext:CommandColumn>
                ...
                <ext:CommandColumn ID="CommandColumn1" runat="server" Width="30">
                    ...
                    <Listeners>
                        <Command Handler="raexcel(record.data.vehiculeid);" />
                    </Listeners>
                </ext:CommandColumn>
