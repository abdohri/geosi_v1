<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RapportPOI.aspx.cs" Inherits="GeoSI.Website.Modules.RapportPOI.RapportPOI" %>
        ...
        <ColumnModel ID="ColumnModel1" runat="server">
            ...
            <Columns>
                ...
                <HeaderItems>
                    ...
                    <Listeners>
                        <Command Handler="rppdf(record.data.vehiculeid);" />
                    </Listeners>
                </ext:CommandColumn>
                ...
                <ext:CommandColumn ID="CommandColumn1" runat="server" Width="30">
                    ...
                    <Listeners>
                        <Command Handler="rpexcel(record.data.vehiculeid);" />
                    </Listeners>
                </ext:CommandColumn>
