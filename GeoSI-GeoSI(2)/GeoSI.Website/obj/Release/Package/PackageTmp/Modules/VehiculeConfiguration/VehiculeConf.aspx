<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VehiculeConf.aspx.cs" Inherits="GeoSI.Website.Modules.VehiculeConfiguration.VehiculeConf" %>
        ...
        <ColumnModel ID="ColumnModel1" runat="server">
            ...
            <Columns>
                ...
                <ext:CommandColumn ID="CommandColumn1" runat="server" Width="30">
                    ...
                    <Listeners>
                        <Command Handler="EditLightboxe(record.data.vehiculeid);" />
                    </Listeners>
                </ext:CommandColumn>
