                ...
                <ext:Panel ID="Panel2"
                    ...
                    <Content>
                        ...
                        <ext:FormPanel StandardSubmit="true" ID="UserForm" Frame="true" runat="server" Method="POST">
                            <Items>
                                <ext:TextField ID="zoneid" Hidden="true" runat="server" Width="310" AllowBlank="false" MaxLength="30" />

                                <ext:TextField ID="nom_zone" runat="server" FieldLabel="<%$ Resources:Resource,Zone_NonZone%>" Width="310" Vtype="chainenum" AllowBlank="false" MaxLength="30" />

                                <ext:TextField ID="tolerance" runat="server" FieldLabel="<%$ Resources:Resource,Zone_Tolerance%>" Width="310" Vtype="num" MaxLength="30" />

                                <ext:ComboBox ID="interditid" DisplayField="interdit" Editable="false" Width="310"
                                ...
                                <ext:Button ID="button5" runat="server" Text="<%$ Resources:Resource,btnvider%>" OnDirectClick="Vider"></ext:Button>
