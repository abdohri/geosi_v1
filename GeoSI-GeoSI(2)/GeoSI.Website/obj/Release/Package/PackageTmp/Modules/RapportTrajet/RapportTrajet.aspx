<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RapportTrajet.aspx.cs" Inherits="GeoSI.Website.Modules.RapportTrajet.WebForm1" %>
        ...
        <ColumnModel ID="ColumnModel1" runat="server">
            ...
            <Columns>
                ...
                <HeaderItems>
                    ...
                    <Listeners>
                        <Command Handler="rtpdf(record.data.vehiculeid);" />
                    </Listeners>
                </ext:CommandColumn>
                ...
                <ext:CommandColumn ID="CommandColumn1" runat="server" Width="30">
                    ...
                    <Listeners>
                        <Command Handler="rtexcel(record.data.vehiculeid);" />
                    </Listeners>
                </ext:CommandColumn>
